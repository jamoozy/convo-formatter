...
public class DeadAIMWriter implements Writer
{
	...
	/**
	 * Creates a new log file with the given {@link Session}.
	 * 
...
//		}
	...
	private void addEvent(Event event)
	{
		...
		if (event instanceof Message)
		{
			...
			{
				// Write the message.
				writer.write(String.format("<b><font color=\"#%s\">%s <font size=1>(%d:%02d:%02d %s)</font>:</font></b> <font color =\"#%s%s%s\" face=\"%s\">%s</font><br />\n",
	...
	public static void main(String[] args)
	{
		...
		if (!writer.makeFile("C:\\temp", s1))
			System.err.println("Error during Test 1");
